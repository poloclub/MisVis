...
getData().then(
    data => {
        ...
        let fakeDomainNumber = data[domainName]["twitter_sim_domain"]["misinformation"];
        let realDomainNumber = data[domainName]["twitter_sim_domain"]["reliable"];
        let othersDomainNumber = data[domainName]["twitter_sim_domain"]["others"];
        ...
        let botNumber = data[domainName]["twitter_bot_user_cnt"];
        let botRatio = botNumber/data[domainName]["twitter_user_cnt"]
